    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                Shower shower = await TakeAShowerAsync(98);
        ...
        private static async Task <Shower> TakeAShowerAsync(int degrees)
        {
            Console.WriteLine($"Warming the water to {degrees} degrees...");
        ...
        private static async Task <Drive> DriveToWorkAsync(int time)
        {
            ...
            //Console.WriteLine("A thunderstorm has started....");
            //Console.WriteLine("A tree was struck by lightening and a brach is blocking the road, so you need to turn around.");
            //throw new InvalidOperationException("Lightening Strike");
            await Task.Delay(1000);
